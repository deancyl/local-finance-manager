...
class TransactionCard extends ConsumerWidget {
  ...
  final List<Split>? splits; // Optional pre-loaded splits (v0.3.188)
  ...
  const TransactionCard({
    ...
    this.splits, // Optional pre-loaded splits
    required this.onTap,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Use pre-loaded splits if provided, otherwise fallback to provider (v0.3.188)
