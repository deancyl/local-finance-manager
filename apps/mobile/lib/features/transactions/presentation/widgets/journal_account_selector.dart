...
/// Usage:
/// ```dart
/// final selectedAccount = await showAccountSelector(context);
/// if (selectedAccount != null) {
///   // Use selected account
/// }
/// ```
class JournalAccountSelector extends ConsumerStatefulWidget {
  /// Pre-selected account ID
  final String? selectedAccountId;
  
  /// Filter to specific account types (null = all types)
  final List<String>? accountTypeFilter;
  
  /// Show account balances
  final bool showBalances;
  
  /// Title for the selector dialog
  final String title;

  const JournalAccountSelector({
    super.key,
  ...
  static Future<Account?> show(
    ...
    final result = await showModalBottomSheet<Account>(
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        maxChildSize: 0.95,
        expand: false,
        builder: (context, scrollController) => JournalAccountSelector(
  ...
  @override
  ConsumerState<JournalAccountSelector> createState() => _JournalAccountSelectorState();
}

class _JournalAccountSelectorState extends ConsumerState<JournalAccountSelector> {
  ...
  void initState() {
    super.initState();
    // Initialize search query provider
    Future.microtask(() {
