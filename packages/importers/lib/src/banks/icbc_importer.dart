...
/// ICBC (工商银行) CSV importer.
///
/// Supports ICBC bank statement exports with:
/// - GBK or UTF-8 encoding
/// - Headers: 交易日期, 交易金额, 账户余额, 交易摘要, etc.
/// - Date format: 20260519 or 2026-05-19
/// - Amount can be positive/negative
class IcbcImporter extends ImporterBase {
  @override
  String get name => '工商银行';

  @override
  String get sourceId => 'icbc';
  ...
  @override
  String get description => '工商银行账户交易记录导入';

  /// ICBC-specific header patterns for detection.
  ...
  bool canParse({
    ...
    // Check for ICBC-specific headers
    ...
    // Also check for ICBC-specific patterns in content
    if (fileResult.header.any((h) => h.contains('工商银行') || h.contains('ICBC'))) {
      return true;
    }
  ...
  ParsedTransaction? _parseRow(
    ...
    final externalId = 'icbc_${date.millisecondsSinceEpoch}_${amount.abs()}_$rowNum';
